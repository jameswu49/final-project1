...
export default function DesktopNavBar() {
  ...
  return (
    <nav className="hidden md:grid grid-cols-3 px-2  py-2.5 sticky top-0 z-20  bg-white drop-shadow-md">

      <ul className="flex w-full justify-evenly rounded-lg md:flex-row text-end md:mt-0 md:text-base md:font-medium items-center">
        <li>
          <a href="#" className="block py-2 pl-3 pr-4 text-black text-sm rounded md:bg-transparent md:p-0 lg:text-base" aria-current="page">Livestream</a>
        </li>
        <li>
          <a href="#" className="block py-2 pl-3 pr-4 text-black text-sm rounded md:hover:text-black md:p-0 lg:text-base ">Sermons</a>
        </li>
        <li>
      ...
      <ul>
        <li className='text-base md:text-xl lg:text-3xl font-thin flex justify-center text-center'>
          <a href="#" className=''>Abide <br /> Ministries</a>
        </li>
      </ul>
      ...
      <ul className="flex w-full justify-evenly rounded-lg md:flex-row text-end md:mt-0 md:text-sm md:font-medium items-center m-w-screen-2xl">
        <li>
          <a href="#" className="block py-2 pl-3 pr-4 text-black text-sm lg:text-base rounded md:hover:text-black md:p-0">About</a>
        </li>
        <li>
          <a href="#" className="block py-2 pl-3 pr-4 text-black text-sm lg:text-base rounded md:hover:text-black md:p-0">Connect</a>
        </li>
        <li>
...
//       <li className='text-base md:text-xl lg:text-3xl font-thin flex text-center'>
//         <a href="#" className=''>Abide <br /> Ministries</a>
//       </li>
