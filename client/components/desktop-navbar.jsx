  ...
  return (
    <nav className="hidden md:grid grid-cols-3 px-2  py-2.5 sticky top-0 z-20  bg-white gold-line forum">
      <ul className="flex w-full justify-evenly rounded-lg md:flex-row text-end md:mt-0 md:text-base md:font-medium items-center">
        <li>
          <Link className="block py-2 pl-3 pr-4 text-black text-sm rounded md:bg-transparent md:p-0 lg:text-base links" to="https://www.youtube.com/@nasungicm3518/streams">Livestream</Link>
        </li>
        <li>
          <Link className='block py-2 pl-3 pr-4 text-black text-sm rounded md:p-0 lg:text-base links' to="/sermons">Sermons</Link>
        </li>
        <li>
          <a href="#" className="block py-2 pl-3 pr-4 text-black text-sm rounded  md:hover:text-black md:p-0 lg:text-base links">Resources</a>
        </li>
      </ul>
      ...
      <ul className="flex w-full justify-evenly rounded-lg md:flex-row text-end md:mt-0 md:text-sm md:font-medium items-center m-w-screen-2xl">
        <li>
          <Link className="block py-2 pl-3 pr-4 text-black text-sm lg:text-base rounded links md:p-0" to="/about">About</Link>
        </li>
        <li>
          <Link className="block py-2 pl-3 pr-4 text-black text-sm lg:text-base rounded links md:p-0" to="/connect">Connect</Link>
        </li>
        <li>
          <Link className="block py-2 pl-3 pr-4 text-black text-sm lg:text-base rounded links md:p-0" to="https://buy.stripe.com/test_28o00Ybn481q6NW3cc">Give</Link>
        </li>
      </ul>
